        ...
        <div class="app-container" ref="appContainer">
            ...
            <div class="header" ref="header">
                <el-form ref="form" :model="search" label-width="120px" :rules="codeRules" style="display: flex;">
                    ...
                    <el-form-item label="所属科室：" style="margin: 0;width: 30%;">
                        <el-select v-model="search.department_id" filterable clearable placeholder="请选择归口科室">
                            <el-option
            ...
            <el-dialog title="添加归口科室帐号" :visible.sync="dialogFormVisible" width="38%">
                <el-form ref="form" :model="form" label-width="120px" :rules="codeRules">
                    ...
                    <el-form-item label="归口科室：" porp="company_id">
                        <el-select v-model="form.department_id" filterable clearable placeholder="请选择归口科室">
                            <el-option
                                    v-for="item in tableForm"
                                    :key="item.department_name"
                                    :label="item.department_name"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getAccounts() {
                let that = this;
                this.$store.dispatch('department/getAccounts',this.search)
                    .then((response) => {
