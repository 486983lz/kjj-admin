        ...
        <el-row>
            <el-col :span="18">
                <div class="app-container">
                    ...
                    <el-row>
                        <el-col :span="24">
                            <p class="notice-title-small">发布时间:{{createFrom.created_at}}&nbsp;&nbsp;联系人:{{createFrom.name}}&nbsp;&nbsp;联系电话:{{createFrom.phone}}&nbsp;&nbsp;行业领域:{{createFrom.industry_name}}</p>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getNoticeInfo(){
                this.$store.dispatch('problem/getProblemInfo',{id:this.createFrom.id})
                    .then((response) => {
