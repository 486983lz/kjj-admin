<template>
    <div class="app-top">
        <router-link :to="{path: 'guide-create'}"><el-button class='btn_right' type="primary">发布指南</el-button></router-link>
            ...
            <div class="header"  ref="header">
                <el-form ref="form" :model="where" label-width="120px" style="display: flex;">
                    <el-form-item label="标题:" label-width="100px" style="margin: 0;width: 30%;">
                        <el-input v-model="where.title" placeholder="请输入指南标题" ></el-input>
                    </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateList(id){
                this.$router.push({name: 'guide_update',query:{id:id}});
            },
            showList(id){
                this.$router.push({name: 'guide_show',query:{id:id}});
            },
            releaseList(id){
            ...
            deleteList(id){
                this.$confirm('此操作将永久删除该指南信息, 是否继续?', '提示', {
